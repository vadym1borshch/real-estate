...
const AssistantCard = ({ assistant, onClick }: Props) => {
  ...
  return (
    <div
      ...
      className="px-5 py-7.5 border w-[16.25rem] min-h-[22.5rem] cursor-pointer flex flex-col items-center gap-6 rounded-lg border-blue-gray hover:border-charcoal"
    >
