...
const DropdownInput = ({ children, open, setOpen, inputValue, setInputValue, dropdownClassName }: Props) => {
  ...
  return (
    <ClickOutsideWrapper onClickOutside={() => {
      setOpen(false)
      ...
      <div ref={containerRef}>
        ...
        />
        {open && (
          <DropdownMenu className={dropdownClassName}>
            {children}
          </DropdownMenu>)
        }
      </div>
