...
const Button = (
  ...
  return (
    <TButton
      ripple={false}
      className={cn(
              'cursor-pointer bg-coral text-xl text-white py-0 px-6 w-fit font-normal shadow-none hover:shadow-none hover:bg-light-coral focus:border-4 focus:border-charcoal !focus:py-0 rounded-sm focus:rounded-lg h-12 disabled:bg-gray',
        {
      ...
      {...rest}
    >
      <span className="flex capitalize gap-[0.125rem] w-full max-h-10 items-center justify-center">
        {children}
        {iconId && (
